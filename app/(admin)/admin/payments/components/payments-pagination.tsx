...
/**
 * Numbered pagination footer for the payments table, matching the reference
 * design's "Showing 1 to 10 of 4,200 payments" + numbered pages.
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3 border-t">
      <span className="text-xs text-muted-foreground">
        Showing {start} to {end} of {totalResults.toLocaleString()} payments
      </span>
